...
uses Vst3Base, Generics.Collections, UVST3Processor, UVST3Controller;
...
type
  ...
  TVST3Instrument = class(TVST3Controller, IComponent, IAudioProcessor,
    IEditController, IMidiMapping, IUnitInfo)
  protected
    ...
    FUnitInfo: IUnitInfo;
    property AudioProcessor: IAudioProcessor read FAudioProcessor
      implements IAudioProcessor;
    property Component: IComponent read FComponent implements IComponent;
    property EditController: IEditController read FEditController
...
type
  TVSTInstrument = TVST3Instrument;
  // don't expand this type with own methods, but inherit!
